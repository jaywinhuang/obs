...
var app_demo = {
    solutions: {
        ...
        if ($("#google_contact").length > 0) {
            var i = "/static/img/map-marker.png", p = {
                    styles: l,
                    zoom: 15,
                    disableDefaultUI: !0,
                    center: new google.maps.LatLng(40.443744, -79.945088),
                    mapTypeId: google.maps.MapTypeId.ROADMAP
                }, c = new google.maps.Map(document.getElementById("google_contact"), p),
                o = new google.maps.LatLng(40.443744, -79.945088);
        ...
        morris: function () {
            ...
            if ($("#charts-lineplot").length > 0) {
                ...
                var n = new Rickshaw.Graph({
                    ...
                    max: 1.2,
                    padding: {top: .1},
                    series: [{data: a, color: "#2D3349", name: "sin"}, {data: t, color: "#76AB3C", name: "sin2"}, {
                        data: e,
                        color: "#4FB5DD",
                        name: "cos"
                    }]
